...
typedef enum ColorSchemes_ {
   ...
   COLORSCHEME_CUSTOM1 = 6,
   COLORSCHEME_BROKENGRAY = 7,
   LAST_COLORSCHEME = 8,
} ColorSchemes;
...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   ...
   [COLORSCHEME_CUSTOM1] = {
      [RESET_COLOR] = ColorPair(Cyan,Black),
      [DEFAULT_COLOR] = ColorPair(Cyan,Black),
      [FUNCTION_BAR] = ColorPair(Black,Yellow),
      [FUNCTION_KEY] = ColorPair(Black,Cyan),
      [PANEL_HEADER_FOCUS] = ColorPair(Black,Yellow),
      [PANEL_HEADER_UNFOCUS] = ColorPair(Black,Yellow),
      [PANEL_SELECTION_FOCUS] = ColorPair(Black,Cyan),
      [PANEL_SELECTION_FOLLOW] = ColorPair(Black,Yellow),
      [PANEL_SELECTION_UNFOCUS] = ColorPair(Black,White),
      [FAILED_SEARCH] = ColorPair(Red,Cyan),
      ...
      [BATTERY] = ColorPair(Yellow,Black),
      [LARGE_NUMBER] = A_BOLD | ColorPair(Red,Black),
      [METER_TEXT] = A_BOLD | ColorPair(Cyan,Black),
      [METER_VALUE] = ColorPair(Yellow,Black),
      [LED_COLOR] = ColorPair(Yellow,Black),
      [TASKS_RUNNING] = A_BOLD | ColorPair(Yellow,Black),
      [PROCESS] = ColorPair(Cyan,Black),
      [PROCESS_SHADOW] = A_BOLD | ColorPair(Black,Black),
      [PROCESS_TAG] = A_BOLD | ColorPair(Yellow,Black),
      [PROCESS_MEGABYTES] = A_BOLD | ColorPair(Yellow,Black),
      [PROCESS_BASENAME] = A_BOLD | ColorPair(Yellow,Black),
      [PROCESS_TREE] = ColorPair(Cyan,Black),
      [PROCESS_THREAD] = ColorPair(Yellow,Black),
      [PROCESS_THREAD_BASENAME] = A_BOLD | ColorPair(Cyan,Black),
      [PROCESS_R_STATE] = ColorPair(Red,Black),
      [PROCESS_D_STATE] = A_BOLD | ColorPair(Red,Black),
      [PROCESS_HIGH_PRIORITY] = ColorPair(Red,Black),
      [PROCESS_LOW_PRIORITY] = ColorPair(Yellow,Black),
      [BAR_BORDER] = A_BOLD | ColorPair(Yellow,Black),
      [BAR_SHADOW] = A_BOLD | ColorPair(Red,Black),
      [SWAP] = ColorPair(Cyan,Black),
      [GRAPH_1] = A_BOLD | ColorPair(Yellow,Black),
      [GRAPH_2] = ColorPair(Yellow,Black),
      [MEMORY_USED] = ColorPair(Cyan,Black),
      [MEMORY_BUFFERS] = ColorPair(Yellow,Black),
      [MEMORY_BUFFERS_TEXT] = A_BOLD | ColorPair(Yellow,Black),
      [MEMORY_CACHE] = ColorPair(Red,Black),
      [LOAD_AVERAGE_FIFTEEN] = ColorPair(Yellow,Black),
      [LOAD_AVERAGE_FIVE] = ColorPair(Yellow,Black),
      [LOAD_AVERAGE_ONE] = A_BOLD | ColorPair(Yellow,Black),
      [LOAD] = A_BOLD,
      [HELP_BOLD] = A_BOLD | ColorPair(Cyan,Black),
      [CLOCK] = ColorPair(Yellow,Black),
      [CHECK_BOX] = ColorPair(Yellow,Black),
      [CHECK_MARK] = A_BOLD | ColorPair(Yellow,Black),
      [CHECK_TEXT] = ColorPair(Cyan,Black),
      [HOSTNAME] = ColorPair(Cyan,Black),
      [CPU_NICE] = ColorPair(Cyan,Black),
      [CPU_NICE_TEXT] = A_BOLD | ColorPair(Cyan,Black),
      [CPU_NORMAL] = A_BOLD | ColorPair(Cyan,Black),
      [CPU_KERNEL] = A_BOLD | ColorPair(Yellow,Black),
      [CPU_IOWAIT] = A_BOLD | ColorPair(Red,Black),
      [CPU_IRQ] = A_BOLD | ColorPair(Cyan,Black),
      [CPU_SOFTIRQ] = A_BOLD | ColorPair(Cyan,Black),
      [CPU_STEAL] = A_BOLD | ColorPair(Cyan,Black),
      [CPU_GUEST] = A_BOLD | ColorPair(Cyan,Black),
   },
